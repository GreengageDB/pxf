 ...
 */
@Slf4j
public abstract class BaseServiceImpl<T> extends PxfErrorReporter {
     ...
     */
    protected OperationResult processData(RequestContext context, PrivilegedAction<OperationResult> action) throws Exception {
